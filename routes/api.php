...
Route::prefix('alta')->group(function () {
    ...
    Route::get('/ids', '\App\Http\Controllers\ApiControllers\AltaController@AltaIDS');
});
...
Route::prefix('bog')->group(function () {
    ...
    Route::post('/installment/callback', '\App\Http\Controllers\ApiControllers\BOGInstallmentController@callback')->name('bog.installment-callback');
