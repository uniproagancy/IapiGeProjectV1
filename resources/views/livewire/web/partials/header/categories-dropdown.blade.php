    ...
    <div class="dropdown w-100">
        <div class="cursor-pointer d-none d-lg-block"
            ...
            <a class="position-absolute top-0 start-0 w-100 h-100" href="{{ route('web.products.index') }}">
                <span class="visually-hidden font-neue">კატეგორიები</span>
            </a>
            <button type="button"
                    class="btn btn-lg btn-secondary dropdown-toggle w-100 rounded-bottom-0 justify-content-start pe-none">
                <i class="ci-grid fs-lg"></i>
                <span class="ms-2 me-auto font-neue">კატეგორიები</span>
            </button>
        </div>
        <button type="button"
            ...
            <i class="ci-grid fs-lg"></i>
            <span class="ms-2 me-auto font-neue" style="font-size: 13px">კატეგორიები</span>
        </button>
