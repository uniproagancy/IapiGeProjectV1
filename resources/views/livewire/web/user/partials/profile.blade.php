    ...
    <div class="tab-content">
        <div class="card border-0 shadow-sm">
                <div class="card-body mt-2 px-5">
                    <h5 class="mb-3" style="font-size: 16px">ინფორმაცია მომხმარებელზე</h5>
                ...
                <div class="card-body mb-2 px-5">
                    <h5 class="mb-3" style="font-size: 16px">პაროლის შეცვლა</h5>
                    @if(!auth()->user()->password)
                        <div class="alert alert-info d-flex align-items-start mb-4">
                            <i class="bi bi-info-circle fs-4 me-3 mt-1"></i>
                            <div>
                                <strong>პაროლი არ არის დაყენებული</strong>
                                <p class="mb-0 mt-1">თქვენ შემოხვედით სოციალური ანგარიშით. დააყენეთ პაროლი დამატებითი უსაფრთხოებისთვის.</p>
                            </div>
                        </div>
                    @endif
