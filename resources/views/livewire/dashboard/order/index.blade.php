            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <button type="button" class="btn btn-icon btn-success mx-50" data-bs-toggle="modal" data-bs-target="#createOrderModal">
                                <i data-feather="plus-square"></i>
                            </button>
                            <button type="button" class="btn btn-icon btn-outline-primary" data-bs-toggle="modal" data-bs-target="#filterOrderModal">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($orders as $order)
                               <tr class="text-center">
                                   ...
                                   <td>
                                       @if($order->trashed())
                                           <a href="#" class="text-body" wire:click="restoreModal({{ $order->id }})">
                                       ...
                                       @else
                                           ...
                                           <a href="#" class="text-body" wire:click="deleteModal({{ $order->id }})">
