<div class="app-content content ">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="alert alert-success" role="alert">
                        <div class="alert-body d-flex align-items-center justify-content-between">
                            ...
                            <button class="btn btn-danger" wire:click="cancelDeliveryModal">მიწოდების გაუქმება</button>
                        </div>
                    </div>
                </div>
                @endif
                <div class="col-12 mb-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <div class="btn-group">
                                <button class="btn btn-primary dropdown-toggle waves-effect waves-float waves-light" type="button" id="dropdownMenuButton6" data-bs-toggle="dropdown" aria-expanded="false">
                                    მოქმედება
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                    ...
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateOrderStatusModal">
                                        <i data-feather="edit"></i>
                                        შეკვეთის სტატუსი
                                    </a>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editOrder">
                                        <i data-feather="edit-2"></i>
                                        შეკვეთის კორექტირება
                                    </a>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#sendToDeliveryCompanyModal">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar pull-up my-0">
                                                    <img src="{{ asset('storage/' . $item->product->main_image) }}" alt="" height="40" width="40" />
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-start">
    ...
    <div wire:ignore.self class="modal fade" id="sendToDeliveryCompanyModal" tabindex="-1" aria-labelledby="sendToDeliveryCompanyModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-2">
                        ...
                        <select class="form-select @error('delivery_company_id') border-danger is-invalid @enderror" wire:model="delivery_company_id">
