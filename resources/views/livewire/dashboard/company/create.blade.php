<div wire:ignore.self class="modal fade" id="createCompanyModal" tabindex="-1" aria-labelledby="createCompanyModalLabel"
     aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-1 col-12">
                            ...
                            <select class="form-select @error('legal_id') border-danger is-invalid @enderror"
                                    id="legal_id" wire:model="legal_id">
                        ...
                        <div class="mb-1 col-6">
                            ...
                            <input type="text" id="lastname" wire:model="code"
                                   class="form-control @error('code') border-danger is-invalid @enderror">
                            @error('code')
                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-1 col-6">
                        ...
                        <div class="mb-1 col-12">
                            ...
                            <input type="text" class="form-control @error('user') border-danger is-invalid @enderror"
                                   wire:model.live.300ms="user" autocomplete="off">
                            @error('user')
