            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <button type="button" class="btn btn-icon btn-success mx-50" data-bs-toggle="modal" data-bs-target="#createUserModal">
                                <i data-feather="user-plus"></i>
                            </button>
                            <button type="button" class="btn btn-icon btn-outline-primary" data-bs-toggle="modal" data-bs-target="#filterUserModal">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                @foreach($users as $user)
                                    <tr class="text-center">
                                        <td>{{ $user->id }}</td>
                                        <td><span @if($user->trashed()) class="badge badge-light-danger" @endif>{{ $user->name }} {{ $user->lastname }}</span></td>
                                        ...
                                        <td>
                                            ...
                                            @if($user->role_id !== 2)
                                                @if($user->trashed())
                                                    <a href="#" class="text-body" wire:click="restoreModal({{ $user->id }})">
                                                        <i class="text-success" data-feather="rotate-ccw"></i>
                                                    </a>
                                                @else
                                                    <a href="#" class="text-body" wire:click="deleteModal({{ $user->id }})">
