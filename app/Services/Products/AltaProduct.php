...
class AltaProduct
{
    ...
    protected string $zenrows_api_key;
    ...
    public function __construct()
    {
        ...
        $this->zenrows_api_key = '605bcf65ed76816fc6305e7f1eb1c612ec31fd62';
        
        if (empty($this->zenrows_api_key)) {
            Log::warning('⚠️  Zenrows API key not configured in config/services.php');
        }
    }
    ...
    public function scanAllIds(): array
    {
        ...
        if (empty($this->zenrows_api_key)) {
            throw new Exception('Zenrows API key is not configured');
        }
